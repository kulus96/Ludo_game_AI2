...
parameters_1 = np.load('/home/lpe/Desktop/master2.sem/AI/ludo_game_AI2/ludopy/Test_best_parameters_parameters.npy',allow_pickle=True)
win_rate_vec = np.load('/home/lpe/Desktop/master2.sem/AI/ludo_game_AI2/ludopy/Test_best_parameters_data.npy')
...
for ER_index, ER_value in enumerate(explore_rate_vec):
	for DF_index, DF_value in enumerate(discount_factor_vec):
		for LR_index, LR_value in enumerate(learning_rate_vec):
			temp_win_rate = np.sum(win_rate_vec[ER_index][DF_index][LR_index][700:])/len(win_rate_vec[ER_index][DF_index][LR_index][700:])
...
plt.savefig('/home/lpe/Desktop/master2.sem/AI/ludo_game_AI2/Images_report/Best_winrate22.png',bbox_inches='tight')
